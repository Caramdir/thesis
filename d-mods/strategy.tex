...
\begin{proof}
    ...
    \begin{equation}
        ...
        Δ^! Δ_!.
    \end{equation}
    We note that the adjunction $\id → j^!j_!$ labeled $α$ is an isomorphism and the composition of the maps in \eqref{eq:lem:central:pf:split_morphism_base_change} is exactly the isomorphism of proper base change \cite[\RomanNum{III}.4.2.1.3]{GaitsgoryRozenblyum:prelim:StudyInDAG}.
