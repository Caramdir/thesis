...
It is often convenient to regard (pretriangulated) dg categories as $k$-linear stable $(∞,1)$-categories, which can be done via the nerve construction \cite{Cohn:arXiv:DGCategoriesAreStableInfinityCategories,Faonte:arXiv:SimplicialNerveOfAnAinfinityCategory}. %\cite[Section~1.3.1]{Lurie:2014-draft:HigherAlgebra}
...
To obtain the statement in our setting one applies an argument similar to \cite[Section~\RomanNum{II}.1.7.2]{GaitsgoryRozenblyum:prelim:StudyInDAG}.
...
We will need to apply this construction in the case where $f$ is not proper.
...
Recall that the Hochschild cohomology of a dg category $\cat C$ is given by the algebra of derived endomorphisms of the identity functor,
\[
