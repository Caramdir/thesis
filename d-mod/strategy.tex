...
\begin{proof}
    ...
    \begin{equation}
        ...
        0.
    \end{equation}
    For the second statement note that the stacks $\lscY{\stack U_i}$ form an open cover of $\lscY{\stack X}$ and apply the same argument as~\eqref{eq:lem:d-mod:cover} backwards.
\end{proof}
